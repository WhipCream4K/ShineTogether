...
--     local dataTable = {
--         [TorchFix_Network.ModData.OnlineID] = player:getOnlineID(),
--         [TorchFix_Network.ModData.AttachedLightIndex] = attachedIndex,
--         [TorchFix_Network.ModData.Battery] = battery,
--         [TorchFix_Network.ModData.IsActivated] = isActivated or false
--     }

--     sendClientCommand(player, TorchFix_Network.Module, TorchFix_Network.Commands.SetActivate, dataTable)
